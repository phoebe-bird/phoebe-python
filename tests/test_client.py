...
class TestPhoebe:
    ...
    def test_hardcoded_query_params_in_url(self, client: Phoebe) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_binary_content_upload(self, respx_mock: MockRouter, client: Phoebe) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    def test_binary_content_upload_with_body_is_deprecated(self, respx_mock: MockRouter, client: Phoebe) -> None:
        respx_mock.post("/upload").mock(side_effect=mirror_request_content)
...
class TestAsyncPhoebe:
    ...
    async def test_hardcoded_query_params_in_url(self, async_client: AsyncPhoebe) -> None:
    ...
    @pytest.mark.respx(base_url=base_url)
    async def test_binary_content_upload(self, respx_mock: MockRouter, async_client: AsyncPhoebe) -> None:
        respx_mock.post("/upload").mock(side_effect=mirror_request_content)
